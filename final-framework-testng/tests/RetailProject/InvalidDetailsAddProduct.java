...
//To Verify whether application displays error message upon entering invalid details while adding a product, using data in excel sheet.
...
public class InvalidDetailsAddProduct {
	...
	public void invalidProductAdd(String ProductName, String MetaTitle, String Model, String Price, String Quantity, String Category) throws InterruptedException{
		...
		String actualErrorMessage=AddMultipleProductPOM.errorMessageDisplayed(); //Save message displayed for validation
		System.out.println(actualErrorMessage);
        String expectedErrorMessage="Warning: Please check the form carefully for errors!\n" + "×"; //Expected Error message
		Assert.assertEquals(actualErrorMessage,expectedErrorMessage); //Verify that appropriate Error message should get displayed		
